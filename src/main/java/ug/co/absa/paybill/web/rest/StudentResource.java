...
import ug.co.absa.paybill.repository.StudentRepository;
import ug.co.absa.paybill.service.StudentService;
import ug.co.absa.paybill.service.dto.StudentDTO;
import ug.co.absa.paybill.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.paybill.domain.Student}.
 */
@RestController
@RequestMapping("/api")
