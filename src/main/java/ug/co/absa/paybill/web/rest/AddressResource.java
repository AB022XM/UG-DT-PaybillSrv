...
import ug.co.absa.paybill.repository.AddressRepository;
import ug.co.absa.paybill.service.AddressService;
import ug.co.absa.paybill.service.dto.AddressDTO;
import ug.co.absa.paybill.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.paybill.domain.Address}.
 */
@RestController
@RequestMapping("/api")
