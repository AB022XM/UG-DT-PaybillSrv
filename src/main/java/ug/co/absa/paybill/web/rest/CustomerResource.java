...
import ug.co.absa.paybill.repository.CustomerRepository;
import ug.co.absa.paybill.service.CustomerService;
import ug.co.absa.paybill.service.dto.CustomerDTO;
import ug.co.absa.paybill.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.paybill.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
